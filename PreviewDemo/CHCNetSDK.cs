...
namespace PreviewDemo
{
    ...
    public class CHCNetSDK
    {
        ...
        public class NET_DVR_SMART_SEARCH_COND
        {
            ...
            public byte bySearchCond;
            public NET_DVR_TIME struStartTime;
            public NET_DVR_TIME struEndTime;
        }
        public enum NET_DVR_DIALOGSENDMODE
        {
            NET_DVR_DIALOG_SENDMODE_FIRSTACK = 1,
            NET_DVR_DIALOG_SENDMODE_AUTOMATIC = 2,
            NET_DVR_DIALOG_SENDMODE_FIRSTFIRST = 3
        }
